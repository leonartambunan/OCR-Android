...
public final class ViewfinderView extends View {
    ...
    static final boolean DRAW_TEXT_LINE_BOXES = true;
...
//  static final boolean DRAW_CHARACTER_TEXT = false;
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (CaptureActivity.showTouchedImage && bitmap!=null && !bitmap.isRecycled()) {
...
//        }
     ...
     */
    public void addResultText(OcrResultText text, Bitmap bitmap) {
