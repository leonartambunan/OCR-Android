...
import com.nio.ocr.ektp.mobile.PreferencesActivity;
...
//  private static final int MIN_PREVIEW_PIXELS = 470 * 320; // normal screen
  ...
  private static final int MAX_PREVIEW_PIXELS = 1200 * 800; // more than large/HD screen
...
//    if (prefs.getBoolean(PreferencesActivity.KEY_DISABLE_CONTINUOUS_FOCUS, true)) {
    ...
    Log.i(TAG, "Chosen resolution: "+bestSize.width+" "+bestSize.height);
